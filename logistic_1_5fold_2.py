...
new_data_train5=new_data[int(len(new_data)/5)::]
new_truth_train5=list_status2[int(len(list_status2)/5)::]
new_data_test5=new_data[0:int(len(new_data)/5)]
new_truth_test5=list_status2[0:int(len(list_status2)/5)]
...
clf3.fit(new_data_train5, new_truth_train5)
print(clf3.score(new_data_test5, new_truth_test5))
print("GaussianNB")
...
NB = GaussianNB().fit(new_data_train5, new_truth_train5)
print(NB.score(new_data_test5, new_truth_test5))
...
neigh.fit(new_data_train5, new_truth_train5)
print(neigh.score(new_data_test5, new_truth_test5))
...
clf2.fit(new_data_train5, new_truth_train5)
print(clf2.score(new_data_test5, new_truth_test5))